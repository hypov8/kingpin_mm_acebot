...
//hypo should i enable do not shoot though players???
#define	MASK_BOT_ATTACK_SOLID		(CONTENTS_SOLID|CONTENTS_WINDOW/*|CONTENTS_MONSTER*/)
#define	MASK_BOT_ATTACK_SOLID_TRANS	(CONTENTS_SOLID|CONTENTS_WINDOW/*|CONTENTS_MONSTER*/|CONTENTS_TRANSLUCENT) //CONTENTS_LADDER?
#define	MASK_BOT_ATTACK_SOLID_FENCE	(CONTENTS_SOLID|CONTENTS_WINDOW/*|CONTENTS_MONSTER*/|CONTENTS_TRANSLUCENT|CONTENTS_ALPHA)
