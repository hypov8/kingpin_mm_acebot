	...
	if (voice_table[ entry ].filename)
	{
		...
		if (deathmatch->value || VectorDistance( g_edicts[1].s.origin, self->s.origin ) < 1024)
		{
           ...
           // {
                ...
                //				gi.sound( self, CHAN_AUTO | CHAN_RELIABLE, (voice_table[ entry ].soundindex ? voice_table[ entry ].soundindex - 1 : (voice_table[ entry ].soundindex = 1 + gi.soundindex ( voice_table[ entry ].filename )) - 1 ), 1.0, 1, 0 );
                else
                ...
                //				gi.sound( self, CHAN_AUTO | CHAN_RELIABLE, (voice_table[ entry ].soundindex ? voice_table[ entry ].soundindex - 1 : (voice_table[ entry ].soundindex = 1 + gi.soundindex ( voice_table[ entry ].filename )) - 1 ), 0.2, 1, 0 );
          //  }
          //  else
         //   {
          //      gi.sound( self, CHAN_VOICE | CHAN_RELIABLE, (voice_table[ entry ].soundindex ? voice_table[ entry ].soundindex - 1 : (voice_table[ entry ].soundindex = 1 + gi.soundindex ( voice_table[ entry ].filename )) - 1 ), 1.0, 1, 0 );
